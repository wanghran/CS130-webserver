...
function(generate_coverage_report)
    ...
    if("${LOWER_CMAKE_BUILD_TYPE}" STREQUAL "coverage")
        ...
        add_custom_command(OUTPUT ${COVERAGE_REPORT_FILE}
            ...
            -e "${CMAKE_SOURCE_DIR}/include/httprequestparser.h"
            -e "${CMAKE_SOURCE_DIR}/include/request.h"
            -e "${CMAKE_SOURCE_DIR}/include/urlparser.h"
            -e "${CMAKE_SOURCE_DIR}/src/server_main.cc"
            -e "${CMAKE_SOURCE_DIR}/src/server.cc"
            -e "${CMAKE_SOURCE_DIR}/src/session.cc"
            -e "${CMAKE_SOURCE_DIR}/src/request.cc"
